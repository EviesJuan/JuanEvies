document.getElementById("generate-pdf").addEventListener("click", async () => {
  ...
  doc.rect(centerX, y, colWidth, rowHeight1, "F");
  doc.rect(centerX + colWidth, y, 177.8 - colWidth, rowHeight1, "F");
  doc.rect(centerX, y, 177.8, rowHeight1);

  // Agregamos los textos de los campos
  doc.setFont(undefined, "normal");
  doc.setTextColor(0);
  doc.text("Cuadrilla:", centerX + 2, y + 5);
  doc.text("Descripción del Equipo:", centerX + colWidth + 2, y + 5);
