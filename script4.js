document.getElementById("generate-pdf").addEventListener("click", async () => {
  ...
  try {
   ...
   y += 12;
    ...
    doc.text("MTTO. Subestaciones Portuguesa:", marginX + col2 + 2, y + 4);
    ...
    // Trabajo a realizar
    let lines = doc.splitTextToSize(fields.trabajoRealizar, 173);
    let height = lines.length * 6 + 8;
    doc.rect(marginX, y, 177.8, height);
    doc.text("Trabajo a Realizar:", marginX + 2, y + 5);
    doc.text(lines, marginX + 2, y + 10);
    y += height + 3;

    // Trabajo realizado
    lines = doc.splitTextToSize(fields.trabajoRealizado, 173);
    height = lines.length * 6 + 8;
    doc.rect(marginX, y, 177.8, height);
    ...
    // Trabajo pendiente
    lines = doc.splitTextToSize(fields.trabajoPendiente, 173);
    height = lines.length * 6 + 8;
    doc.rect(marginX, y, 177.8, height);
